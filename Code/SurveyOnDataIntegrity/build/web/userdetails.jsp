    ...
    <div class="container-fluid">
        ...
        <section class="box-intro">
            <div class="table-cell">
                ...
                <h3 style="color: yellow">Data User Details</h3>
                <h3 style="color: red"><center> <table style="width: 800px" summary="Summary Here" cellpadding="0" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Name</th>
                            ...
                            <%
                                ...
                                try {
                                    ...
                                    rs = st.executeQuery("select * from ureg");
                                    while (rs.next()) {%>
