    ...
    <div class="container-fluid">
        ...
        <nav>
            <ul class="box-primary-nav">
                ...
                <li><a href="services.html">Data User</a></li>
                <li><a href="portfolio.html">TPA</a></li>
        ...
        <section class="box-intro">
            <div class="table-cell">
                ...
                <h2>Secret Code</h2>
                <h3 style="color: red"><form action="ulog3.jsp" method="post">
          <p>              
              <h3 style="color:black">Secret Code:&nbsp;&nbsp;<input style="width: 200px;height: 22px;" type="text" name="name" id="name" value="" /> 
          </p><br>
