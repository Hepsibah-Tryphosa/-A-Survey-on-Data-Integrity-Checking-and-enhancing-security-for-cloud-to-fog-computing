    ...
    <div class="container-fluid">
        ...
        <section class="box-intro">
            <div class="table-cell">
                ...
                <h3 style="color: red"><div id="respond">
        <form action="tpalog.jsp" method="post">
          <p>              
              Username:<input style="width: 200px;height: 22px;" type="text" name="name" id="name" value="" /> &nbsp;&nbsp;
            
          </p><br>
          <p>              
            Password:<input style="width: 200px;height: 22px;" type="password" name="pass" id="password" value="" /> &nbsp;&nbsp;
